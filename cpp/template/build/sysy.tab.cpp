...
#line 86 "/root/compiler/sysy-make-template/build/sysy.tab.cpp"
...
#line 63 "/root/compiler/sysy-make-template/src/sysy.y"
            {
    auto comp_unit = make_unique<CompUnitAST>();
    comp_unit->func_def = unique_ptr<BaseAST>((yyvsp[0].ast_val));
    ast = std::move(comp_unit);
  }
#line 1090 "/root/compiler/sysy-make-template/build/sysy.tab.cpp"
    break;
...
#line 90 "/root/compiler/sysy-make-template/src/sysy.y"
    ...
    (yyval.ast_val) = func_def.release();
    // release() 用于把 unique_ptr 里的裸指针拿出来, 避免被 delete
    // 为什么不能用 std::move 直接把 unique_ptr 传过去?
    // 因为 $$ 不是 unique_ptr 类型, 而是 BaseAST* 类型
    // 为什么？
    // 因为我们在 %type 里把 FuncDef 定义成了返回 BaseAST* 类型
  }
#line 1107 "/root/compiler/sysy-make-template/build/sysy.tab.cpp"
    break;

  case 4: /* FuncType: INT  */
#line 111 "/root/compiler/sysy-make-template/src/sysy.y"
        {
    (yyval.ast_val) = new FuncTypeAST();
  }
#line 1115 "/root/compiler/sysy-make-template/build/sysy.tab.cpp"
    break;

  case 5: /* Block: '{' Stmt '}'  */
#line 123 "/root/compiler/sysy-make-template/src/sysy.y"
                 {
    auto block = new BlockAST();
    block->stmt = unique_ptr<BaseAST>((yyvsp[-1].ast_val));
    (yyval.ast_val) = block;
  }
#line 1125 "/root/compiler/sysy-make-template/build/sysy.tab.cpp"
    break;

  case 6: /* Stmt: RETURN Number ';'  */
#line 137 "/root/compiler/sysy-make-template/src/sysy.y"
                      {
    auto stmt = new ReturnStmtAST();

    auto num_node = new NumberAST();
    num_node->value = (yyvsp[-1].int_val);                 // $2 是 int（来自 Number）
    stmt->number = unique_ptr<BaseAST>(num_node);

    (yyval.ast_val) = stmt;
  }
#line 1139 "/root/compiler/sysy-make-template/build/sysy.tab.cpp"
    break;

  case 7: /* Number: INT_CONST  */
#line 154 "/root/compiler/sysy-make-template/src/sysy.y"
              {
    (yyval.int_val) = (yyvsp[0].int_val);  // 把 token 的整数值直接作为 Number 的值返回
  }
#line 1147 "/root/compiler/sysy-make-template/build/sysy.tab.cpp"
    break;


#line 1151 "/root/compiler/sysy-make-template/build/sysy.tab.cpp"
...
#line 161 "/root/compiler/sysy-make-template/src/sysy.y"
